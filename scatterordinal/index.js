...
function plotData() {
  var data=[{category:'A',peakheight:2.5},{category:'A',peakheight:18},{category:'A',peakheight:30},{category:'C',peakheight:40},{category:'C',peakheight:12},{category:'C',peakheight:12}];
  // Define Extent for each Dataset
  xScale.domain(data.map(function(d) { return d.category; }));
  yScale.domain([0, d3.max(data, function(d) { return d.peakheight; })]);
  // Add Axes
  // X AXIS
  g.append("g")
  ...
  g.selectAll(".cir")
    ...
    .enter().append("circle")
      ...
      .attr("cy", function(d) { return yScale(d.peakheight); })
      .attr('r', 3)


	var data2=[{category:'A',peakheight:0},{category:'A',peakheight:1},{category:'A',peakheight:3},{category:'C',peakheight:0},{category:'C',peakheight:2},{category:'C',peakheight:3.5}];
//	var triangleSize= 3;
...
//      .attr("d",function(d) { return d; })
   ...
   .enter()
   .append('path')
   .attr('transform',function(d,i) { return "translate("+[+xScale(d.category), +yScale(d.peakheight)]+")";})
